...
from neuromp.model.randomSearch import RandomSearch

ex = Experiment('Pi Random Search')
...
@ex.automain
@LogFileWriter(ex)
def main(_log, _run, code, num_sample):
    ...
    for j, p in enumerate(gs.sample(num_sample)):
